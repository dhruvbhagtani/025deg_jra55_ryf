...
#PBS -l storage=gdata/hh5+gdata/ik11+gdata/cj50+scratch/v45+scratch/x77+scratch/g40+gdata/x77
#PBS -N sync
...
SYNCDIR=/g/data/x77/db6174/access-om2/archive/025deg_jra55_ryf_param_kpp3
